  ...
  render() {
    ...
    return (
      <div className="mmProgress" ref="mmProgress" onClick={this.barClick}>
        ...
        <div className="mmProgress-inner" ref="mmProgressInner" style={{width: `${offsetWidth}px`}}>
          <div className="mmProgress-dot" onMouseDown={this.barDown} onTouchStart={this.barDown}/>
        </div>
      </div>
    )
  }
